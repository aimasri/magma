 ...
 *
 * Purpose:
 * - Defines the contract for resolving the active tenant/vendor and optional venue identity from incoming HTTP requests.
 ...
 *
 * Why / Why this design:
 * - Strategy Pattern & Dependency Inversion: Core framework persistence layers and middleware depend on this abstraction rather than hardcoding vendor session logic. Different applications (e.g. B2B SaaS with custom subdomains vs Multi-tenant API with headers) can plug in custom resolvers seamlessly.
 *
 * Teaching notes:
